 ...
 */
public class DeSyncAdapterService extends Service {
    private static       DeSyncAdapter syncAdapter     = null;
     ...
     */
        synchronized (syncAdapterLock) {
            if (syncAdapter == null) {
                syncAdapter = new DeSyncAdapter(getApplicationContext(), true);
            }
        }
    }
