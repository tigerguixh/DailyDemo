...
public class SyncAdapterManager {
    ...
    public static final String DEAUTHORITY    = "com.eutechpro.syncadapterexample.deprovider";
    public static final String ACCOUNT_TYPE = "com.eutechpro.syncadapterexample";
    public static final String ACCOUNT      = "个性生活";
    ...
    public static void forceRefresh() {
        ...
        //ContentResolver.requestSync(newAccount, DEAUTHORITY, bundle);
    }
}
